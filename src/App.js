      ...
      <div>
          ...
          <Jumbotron fluid style={{ minHeight: "400px" }}>
            <div style={{ marginLeft: "100px" }}>
              <Row>
                <Col xs="7" lg="5">
                  <p>
                    Santosh owns 15 plots of land in the block of Rau Pusa. The
                    area falls under middle Gangetic plain agro climatic zone.
                    The lands of this zone which are alluvial plains are sloppy
                    towards the south east direction with a very low gradient as
                    evidenced by the direction in which the rivers flow.
                  </p>
                  <p>
                    The rivers of Burhi Gandak, Baya, Kosi, Kamla, Kareh,
                    Jhamwari and Balan flow in Samastipur. As all the rivers and
                    rivulets originate in the high Himalayas, dominated by
                  ...
                  <p>
                    ...
                    although of good to moderate permeability, have become some
                    what poorly drained due to high water table in the areas.
                    The soils are moderately rich to poor in nitrogen
                    ...
                    deficiency of zinc and iron mostly induced by high available
                    calcium.
                  </p>
                </Col>
                <Col xs="4" lg="2 " />
                ...
                <Col xs="4" lg="3">
                  <div>
                    ...
                    >
                      ...
                      <br />
                      <small style={{ marginTop: "-40px", color: "gray" }}>
        ...
        >
          <div
            ...
            data-aos-easing="ease-in-out"
          >
            <div style={{ marginTop: "70px", marginLeft: "0px" }}>
              <Row>
                <Col xs="12" lg="8" />
                <Col xs="6" lg="4">
                  <Row>
